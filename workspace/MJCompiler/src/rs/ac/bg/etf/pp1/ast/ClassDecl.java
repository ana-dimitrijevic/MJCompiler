...
public class ClassDecl extends VarDeclar {
    ...
    public ClassDecl (AbstractModif AbstractModif, String I2, ClassExtends ClassExtends, ClassVarDeclList ClassVarDeclList, ClassMethDeclList ClassMethDeclList) {
