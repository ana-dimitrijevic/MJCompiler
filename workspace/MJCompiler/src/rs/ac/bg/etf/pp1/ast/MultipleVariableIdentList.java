...
public class MultipleVariableIdentList extends VarIdentList {

    private VarIdentList VarIdentList;
    private VarIdent VarIdent;

    public MultipleVariableIdentList (VarIdentList VarIdentList, VarIdent VarIdent) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleVariableIdentList(\n");
