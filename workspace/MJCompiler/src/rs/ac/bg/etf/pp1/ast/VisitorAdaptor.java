...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(RelopExprConditionFactor RelopExprConditionFactor) { visit(); }
    ...
    public void visit(NumberConstFactor NumberConstFactor) { visit(); }
    public void visit(DesignatorFactor DesignatorFactor) { visit(); }
    public void visit(SingleFactor SingleFactor) { visit(); }
    public void visit(MultipleFactor MultipleFactor) { visit(); }
    public void visit(SingleAddopTerm SingleAddopTerm) { visit(); }
    ...
    public void visit(ProcCallStart ProcCallStart) { visit(); }
    ...
    public void visit(SimpleFormalParameter SimpleFormalParameter) { visit(); }
    ...
    public void visit(LeftBrace LeftBrace) { visit(); }
    ...
    public void visit(BoolConstInitializer BoolConstInitializer) { visit(); }
    public void visit(CharConstInitializer CharConstInitializer) { visit(); }
    public void visit(NumConstInitializer NumConstInitializer) { visit(); }
    public void visit(SingleConstInitializer SingleConstInitializer) { visit(); }
    public void visit(ConstInitializerList ConstInitializerList) { visit(); }
    public void visit(Type Type) { visit(); }
    public void visit(NoClassMethodDeclList NoClassMethodDeclList) { visit(); }
    public void visit(ClassMethodDeclList ClassMethodDeclList) { visit(); }
    public void visit(NoClassVarDeclarationList NoClassVarDeclarationList) { visit(); }
    public void visit(ClassVarDeclarationList ClassVarDeclarationList) { visit(); }
    public void visit(NoExtesion NoExtesion) { visit(); }
    public void visit(Extension Extension) { visit(); }
    public void visit(NoAbstractModifer NoAbstractModifer) { visit(); }
    public void visit(AbstractModifer AbstractModifer) { visit(); }
    ...
    public void visit(VariableIdentError VariableIdentError) { visit(); }
    public void visit(ArrayVariableIdent ArrayVariableIdent) { visit(); }
    public void visit(SingleVariableIdent SingleVariableIdent) { visit(); }
    public void visit(SingleVariableIdentList SingleVariableIdentList) { visit(); }
    public void visit(MultipleVariableIdentList MultipleVariableIdentList) { visit(); }
    ...
    public void visit(VarDeclNonConst VarDeclNonConst) { visit(); }
    public void visit(VarDeclConst VarDeclConst) { visit(); }
